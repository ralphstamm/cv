...
\definecolor{VividPurple}{HTML}{00009A}
...
\begin{document}
\name{Ralph Stamm}
\tagline{Business Man \& Digital Native}
% Cropped to square from https://en.wikipedia.org/wiki/Marissa_Mayer#/media/File:Marissa_Mayer_May_2014_(cropped).jpg, CC-BY 2.0
%http://stamm.surf/cv/ralphstamm.png
%\photo{2.5cm}{}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{privat@ralphstamm.com}
%   \phone{000-00-0000}
  \mailaddress{Seefeldstrasse 6, 8610 Uster}
  \location{Sunnyvale, CA}
  \homepage{marissamayr.tumblr.com/}
  \twitter{@ralphstamm}
  \linkedin{ch.linkedin.com/in/ralphstamm}
...
\cvevent{Senior Digital Analyst / Team Leader}{Unic}{July 2016 -- Ongoing}{Zurich}
\begin{itemize}
...
\cvevent{Search \& Analytics Specialist}{Helvetia Insurance}{Nov 2011 -- June 2016}{St.Gallen}
\begin{itemize}
...
\cvevent{Digital Strategy Manager}{Adecco management \& consulting S.A.}{Feb 2011 --  Aug 2011}{Glattbrugg}

\divider

\cvevent{Digital Marketing Program Manager}{Cisco Systems (Switzerland) GmbH /(V5 GmbH)}{Oct 2001 -- July 2005}{Wallisellen}
